...
de cada palavra em cada contexto. A Indução Semântica de Palavras tenta resolver
este problema ao aglomerar palavras que ocorram juntas frequentemente em corpora
não anotados. Este projeto, \acf*{SENTIDO}, tenta resolver este problema para a
língua portuguesa utilizando algoritmos com base em grafos.
